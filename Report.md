...
پروژه‌ای که برای این آزمایش در نظر گرفته‌ایم، یک پیام‌رسان ساده است که امکانات مختلفی نظیر ثبت‌نام، ورود به حساب، نمایش کاربران آنلاین، اضافه کردن یک گروه جدید، ارسال پیام به یک کاربر آنلاین دیگر است. جزئیات نحوه کار با برنامه در بخش README قابل مشاهده است.
## مراحل انجام آزمایش
### قسمت اول
در ابتدا، همانطور که در دستور کار گفته شده است؛ باید شاخه main را محافظت کنیم. به طوری که کسی قادر به تغییر دادن مستقیم این شاخه نباشد و تنها راه تغییر این شاخه، ارسال درخواست ادغام یا merge request باشد.
